...
const Icons = {
    ...
    logo: (props: LucideProps) => (
        <svg {...props} width="140" height="33" viewBox="0 0 140 33" fill="none" xmlns="http://www.w3.org/2000/svg" >
            {/* Icon */}
            ...
            <text x="38" y="25" fill="white" fontSize="22" fontWeight="500" fontFamily="Arial, Helvetica, " >
                Tender
            </text>
