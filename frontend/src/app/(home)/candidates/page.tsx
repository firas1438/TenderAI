...
import MatchResult from "@/components/candidates/MatchResult";
        ...
        <div className="relative z-0 w-full h-full">
          ...
          <Wrapper className="py-12">
            <div className="flex flex-col items-center justify-center w-full z-10">
              ...
              <Container delay={0.2}>
                <p className="text-base md:text-md font-normal text-center text-balance text-muted-foreground max-w-3xl mx-auto mt-4">
